...
urlpatterns = [
    ...
    path("modelos-resposta/", views.listar_respostas_rapidas_view, name="listar_respostas_rapidas"),
    path("modelos-resposta/novo/", views.criar_resposta_rapida_view, name="criar_resposta_rapida"),
    ...
    path(
        "tecnico/<int:pk>/movimentacoes/<int:movimentacao_pk>/remover/",
        views.remover_movimentacao_view,
        name="remover_movimentacao",
    ),
